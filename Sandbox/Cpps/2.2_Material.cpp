...
#if ACTIVE_LESSON_MAJOR == 2 && ACTIVE_LESSON_MINOR == 2 && TEST == 0
...
int main()
{
    ...
    Shader shader({
        ...
        {Shader::Type::FragmentShader, ASSET("2.2_Material/material_fragment.glsl")}
        });
    shader.Bind();
    ...
    windowInstance->RenderLoop([&]() {
        ...
        light.position = glm::vec3(sin(glfwGetTime()), 1.0f, cos(glfwGetTime()));
